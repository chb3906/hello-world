export function itemType(data, keyName){
    // debugger;
	this.data=data || [];
...
itemType.prototype={
	render:function(){
		...
		var html='<div id="addressBox" class="show"><div class="addContent"><nav class="tabs"><span class="cur">请选择</span></nav><ul class="addBody">'
	...
	event:function(){
		...
		$(this.content).on("click",".addBody li",function(){
			...
			if(_this.num < _this.keyName.length){
	...
	close:function(){
		...
		var _key= _this.keyName
	    arr.forEach(function(item,index){
				// console.log(data[item]);
	        var nowKey=_key[index]
					cityCode = data[item].regionCode;
					_selectArr.push(data[item].regionCode);
